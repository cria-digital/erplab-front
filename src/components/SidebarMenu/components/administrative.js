...
const Administrative = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-5 px-[12px]">
      ...
      <Link href="/administrativo/pacientes" className="w-full">
        <div
          className={`${pathname === '/administrativo/pacientes' ? 'bg-[#2B2B2B]' : ''} flex h-[44px] w-full items-center gap-5 rounded-[4px] px-2 hover:bg-[#2B2B2B]`}
        >
